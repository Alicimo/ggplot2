...
import pandas as pd
from ggplot import aes, geom_point, ggplot, stat_ellipse
from ggplot.stats.stat_ellipse import cov_trob
...
def test_cov_trob_2d():
    ...
    cor = [[1.0000000, 0.9337562], [0.9337562, 1.0000000]]
...
def test_cov_trob_3d():
    ...
    cov = [
        [1.9412275, 2.713547, 0.7242778],
        [2.7135469, 4.479363, 1.2210262],
        [0.7242778, 1.221026, 1.6008466],
    ]
    cor = [
        [1.0000000, 0.9202185, 0.4108583],
