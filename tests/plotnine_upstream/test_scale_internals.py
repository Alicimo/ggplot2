...
from ggplot.scales.scale_alpha import (
    scale_alpha_continuous,
    scale_alpha_discrete,
)
from ggplot.scales.scale_linetype import (
    scale_linetype_continuous,
    scale_linetype_discrete,
)
from ggplot.scales.scale_shape import (
    scale_shape_continuous,
    scale_shape_discrete,
)
from ggplot.scales.scale_size import (
    scale_size_area,
    scale_size_continuous,
    scale_size_discrete,
    scale_size_radius,
)
from ggplot.scales.scale_xy import (
    scale_x_continuous,
    scale_x_datetime,
    scale_x_discrete,
    scale_x_log10,
...
from ggplot.scales.scales import make_scale
